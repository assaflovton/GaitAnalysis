...
//      Serial.print("lastangVelY1:");
//      Serial.print(',');
//      Serial.println(last_ang_velY1);
//      Serial.print("lastangVelY2:");
//      Serial.print(',');
//      Serial.println(last_ang_velY2);

      if (angVelY > last_ang_velY1 and last_ang_velY2 > last_ang_velY1 and angVelY < 0 and state == MS ) { //max
      ...
      if (angVelY > last_ang_velY1 and last_ang_velY2 > last_ang_velY1 and angVelY < -50 and state == HS ) { //max
        state = TF;
